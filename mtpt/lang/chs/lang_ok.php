...
(
	...
	'std_cookies_disabled_note' => "<p>你的账号已成功激活！但是，你没有自动登录，你需要用刚才申请到的用户名和密码重新登录。<br />如果登录不成功请到群聊区咨询或者加新手群145543216寻求帮助<br /><a class=altlink href=\"login.php\">点击这里登录</a>。</p>\n",
...
//或者是因为你禁用了浏览器的cookies。你必须启用cookies才能使用你的账号。请启用cookies然后再次尝试
